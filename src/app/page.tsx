          ...
          <div className="container-site max-w-3xl mx-auto">
            ...
            <details className="group mt-8">
              <summary className="list-none cursor-pointer flex justify-center">
                <span className="btn-secondary inline-flex items-center gap-2 text-base px-7 py-3 select-none">
                  <span className="group-open:hidden">Leer nota completa ↓</span>
                  <span className="hidden group-open:inline">Cerrar ↑</span>
                </span>
              </summary>

              <div className="mt-8 space-y-5 text-xl text-avade-marron-oscuro leading-relaxed">
                <p>
